...
from src.agents.tools import get_current_weather, get_distance_and_route, estimate_trip_budget, fetch_location_images
...
def create_odisha_agent():
    ...
    image_tool = fetch_location_images
    
    tools = [weather_tool, distance_tool, budget_tool, rag_tool, image_tool]
